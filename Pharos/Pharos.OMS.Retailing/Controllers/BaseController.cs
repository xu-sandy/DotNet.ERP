...
namespace Pharos.OMS.Retailing.Controllers
{
    public class BaseController : AsyncController
    {
        ...
        /// <param name="selectValue"></param>
        /// <returns></returns>
        protected IList<SelectListItem> ListToSelect(IEnumerable<SelectListItem> ies, string emptyTitle = null, int? selectValue = null)
        {
        ...
        /// <param name="selectValue"></param>
        /// <returns></returns>
        protected IList<DropdownItem> ListToSelect(IEnumerable<DropdownItem> ies, string emptyTitle = null, byte? selectValue = null)
        {
            if (ies == null) return null;
            var list = ies.ToList();
            if (emptyTitle != null) list.Insert(0, new DropdownItem() { Text = emptyTitle, Value = "", IsSelected = true });
            if (selectValue.HasValue)
            {
                var obj = list.FirstOrDefault(o => o.Value == selectValue.Value.ToString());
