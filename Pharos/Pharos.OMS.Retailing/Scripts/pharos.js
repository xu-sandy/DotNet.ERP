...
pharos.viewinfo = pharos.viewinfo || false;
(function (para) {
...
function openDialog420(title, url, showAdd, hideSave) {
    openDialogNew(title, url, 420, 230, hideSave, !showAdd);
}
function openDialog600(title, url, showAdd, hideSave) {
    openDialogNew(title, url, 600, 370, hideSave, !showAdd);
}
function openDialog800(title, url, showAdd,hideSave) {
    openDialogNew(title, url, 800, 450, hideSave, !showAdd);
}
function openDialog1000(title, url, showAdd, hideSave) {
    openDialogNew(title, url, 1000, 560, hideSave, !showAdd);
}
...
function openDialogNew(title, url, width, height, hideSave, hideAdd, buttons) {
    ...
    $("body").openTopDialog({
        ...
        onBeforeClose:closeDialogBefore,
