(function(root, factory) {
    ...
    var defaults = {
        ...
        TEMPLATE = [
            ...
            '<a href="javascript:;" data-calendar-display-date class="calendar-display" title="选择月份">',
            ...
            '<div class="calendar-hd">',
            '<a href="javascript:;" data-calendar-display-month class="calendar-display" title="返回到日期列表">{yyyy}</a>',
            '<div class="calendar-arrow">',
