...
namespace Pharos.Store.Retailing.Controllers
{
    public class STHouseMoveController : BaseController
    {
        ...
        public ActionResult MoveinIndex()
        {
            ...
            ViewBag.inshops = list.Where(o => o.Value != Sys.SysCommonRules.CurrentStore).ToList();
        ...
        public ActionResult MoveinAdd(int? id)
        {
            ...
            ViewBag.outshops = list.Where(o => o.Value != Sys.SysCommonRules.CurrentStore).ToList();
            ViewBag.inshops = list.Where(o => o.Value == Sys.SysCommonRules.CurrentStore).ToList();
