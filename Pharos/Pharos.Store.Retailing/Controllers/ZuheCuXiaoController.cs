...
{
    public class ZuheCuXiaoController : BaseController
    {
        //
        // GET: /MaiZengCuXiao/
        ...
        {
            int count = 0;
            var list = CommodityPromotionService.ZuhePageList(Request.Params, out count, true);
        ...
        //    var re = CommodityPromotionService.ZuheSaveOrUpdate(obj, Request["Times"]);
