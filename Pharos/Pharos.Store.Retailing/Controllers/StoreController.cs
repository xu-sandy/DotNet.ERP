...
namespace Pharos.Store.Retailing.Controllers
{
    public class StoreController : BaseController
    {
                ...
                else if (csid.message == "success")
                {
                    ...
                    else
                    {
                        if (Cookies.IsExist("storeremuc"))
                        {
                            ...
                            //cookie的门店ID
                            string sid = Server.UrlDecode(Cookies.Get("storeremuc", "_storeId"));
                            sid = sid.Split('~')[0];
        ...
        {
            #region 如未登录 或 非门店登录，则跳转到 门店登录页
            if (!Sys.CurrentStoreUser.IsLogin || !Sys.CurrentStoreUser.IsStore)
            {
                Sys.CurrentStoreUser.Exit();
                return RedirectToAction("Login");
            }
        ...
        {
            ViewBag.shops = ListToSelect(WarehouseService.GetList().Where(o => o.StoreId == Sys.SysCommonRules.CurrentStore).Select(o => new SelectListItem() { Value = o.StoreId, Text = o.Title }), selectValue: Sys.SysCommonRules.CurrentStore);
            ...
            var curUserName = Sys.CurrentStoreUser.UserName;
            var createUID = Sys.CurrentStoreUser.UID;
            var model = new InboundGoods() { InboundType = 1 };
            var supplierTitle = "";
        ...
        public ActionResult InboundGoodsManagement()
        {
            ...
            ViewBag.stores = ListToSelect(WarehouseService.GetList().Where(o => o.StoreId == Sys.SysCommonRules.CurrentStore).Select(o => new SelectListItem() { Value = o.StoreId, Text = o.Title, Selected = true }));
        ...
        public ActionResult OutboundGoods(string outboundId, byte? selectType)
        {
            ...
            var curUserName = Sys.CurrentStoreUser.UserName;
            var curUID = Sys.CurrentStoreUser.UID;
        ...
        public void Export()
        {
            ...
            if (Sys.CurrentStoreUser.IsStore)
            {
        ...
        public ActionResult AddStorage(Warehouse obj)
        {
            ...
            {
                var auth = Pharos.Sys.CurrentStoreUser.Company as CompanyAuthorize;
                ...
                obj.CreateUID = Sys.CurrentStoreUser.UID;
                obj.State = 1;
        ...
        public ActionResult Login(UserLogin user)
        {
            ...
            if (op.Successed && Pharos.Sys.CurrentStoreUser.Company != null && Pharos.Sys.CurrentStoreUser.Company.StoreProper == "N")
            {
        ...
        public csID ipLocalhost()
        {
            ...
            {
                localhost = RouteData.Values["dom"].ToString();
            }
