...
namespace Pharos.Logic.ApiData.Pos.DataAdapter
{
    ...
    public interface IDataAdapter
    {
        ...
        StoredValueCardRechargeResult StoredValueCardRecharge(int type,string cardNo, decimal amount);

        IEnumerable<object> GetAreas(int pid);

        MembershipCard GetStoredValueCardInfo(string cardNo);

        IEnumerable<StoredValueCardPayDetailsItem> GetStoredValueCardPayDetails(string cardNo, DateTime start, DateTime end);

        void SaveToStoredValueCard(string cardNo, decimal amount, decimal balance);

        string GetLastMemberNo();
    }
}
