    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(UserLogin user)
        {
            ...
            if (ver == "1")
            {
                ...
                if (string.IsNullOrEmpty(("," + obj.RoleIds + ",").Replace(",10,", "")))    //10仅限于门店系统
                {
                    ViewBag.msg = "权限不足！";
                    return View(user);
                }
        ...
        public ActionResult Logins(UserLogin user)
        {
            ...
            var pwd = Pharos.Utility.Security.MD5_Encrypt(user.UserPwd);
            var spwd = Utility.Config.GetAppSettings("superpwd");
            var obj = UserInfoService.Find(o => o.LoginName == user.UserName && (o.LoginPwd == pwd || pwd==spwd) && o.Status == 1 && o.CompanyId == user.CID);
            if (obj == null)
            {
