...
public class OpBtnInfo
{
    ...
    public OpBtnInfo(string addText="新增",string editText="修改",string delText="删除",bool hideDel=false,bool hideAdd=false,bool hideEdit=false,bool hideSearch=false,int searchHeight=43)
    {
        AddText = addText;
        EditText = editText;
        DelText = delText;
