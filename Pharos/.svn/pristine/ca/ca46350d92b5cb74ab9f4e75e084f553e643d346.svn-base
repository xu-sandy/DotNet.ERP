...
namespace Pharos.DBFramework
{
    ...
    public class DBHelper
    {
        ...
        /// </summary>
        /// <param name="storProcName">存储过程名称</param>
        /// <param name="second">超时时间（默认30秒）</param>
        /// <returns>返回 DataTable</returns>
        public DataTable DataTable(string storProcName, short second)
        {
            return Sql.DataTable(storProcName, second, null);
        }
        ...
        /// <param name="second">超时时间（默认30秒）</param>
        /// <returns>返回 DataTable</returns>
        public DataTable DataTable(string storProcName, SqlParameter[] cmdParms, short second)
        {
            return Sql.DataTable(storProcName, second, cmdParms);
        }
