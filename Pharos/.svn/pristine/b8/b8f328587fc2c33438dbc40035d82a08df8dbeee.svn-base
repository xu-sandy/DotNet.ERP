...
namespace Pharos.Store.Retailing.Controllers
{
    public class MembersController : BaseController
    {
        ...
        public ActionResult CreateMember(int? id)
        {
            ...
            ViewBag.storeTitle = WarehouseService.Find(o => o.CompanyId == Sys.SysCommonRules.CompanyId && o.StoreId == Sys.SysCommonRules.CurrentStore).Title;
        ...
        {
            if (objData.Id == 0)
                objData.StoreId = Sys.SysCommonRules.CurrentStore;
            else
                objData.StoreId = Request.Params["modelStore"];
            var obj = objData;
        ...
        //    int count = 0;
        //    object footer = null;
        //    var result = _memberRechargeBll.FindRechargePageList(beginDate, endDate, keyWold.Replace(" ", ""), keywoldType, out count, ref footer);
