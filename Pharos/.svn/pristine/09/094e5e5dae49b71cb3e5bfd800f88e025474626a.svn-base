...
namespace Pharos.Store.Retailing.Controllers
{
    public class ProductController : BaseController
    {
        ...
        public ActionResult Export(string datas)
        {
            ...
            //    }
            //});
            var dt = list.ToDataTable<VwProductModel>();
            var fileName = "散称商品";
            var fields = new List<string>() { "ProductCode", "Barcode", "CategoryTitle", "Title", "Size", "BrandTitle", "SysPrice", "SysPriceStr", "SubUnit" };
            var names = new List<string>() { "货号", "条码", "品类", "品名", "规格", "品牌", "售价", "售价", "单位" };
