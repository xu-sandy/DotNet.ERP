...
{
    public class PromotionBlendListDataSyncService : BaseDataSyncService<PromotionBlendList, PromotionBlendListForLocal>
    {
        public override IEnumerable<PromotionBlendList> Download(string storeId, string entityType)
        {
