...
namespace Pharos.Logic.BLL
{
    public class MembershipCardBLL
    {
        ...
        public object FindMembershipCardPageList(string type, short? state, int beOverdue, DateTime? dueTimeStart, DateTime? dueTimeEnd, string keyWord,int[] cardType, out int count)
        {
            return _service.FindMembershipCardPageList(type, state, beOverdue, dueTimeStart, dueTimeEnd, keyWord,cardType, out count);
        }
