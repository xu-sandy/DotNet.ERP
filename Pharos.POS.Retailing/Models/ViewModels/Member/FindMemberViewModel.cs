...
namespace Pharos.POS.Retailing.Models.ViewModels
{
    public class FindMember : BaseViewModel
    {
        ...
        private IEnumerable<MemberCard> _MemberCards;
        public IEnumerable<MemberCard> MemberCards
        {
            get { return _MemberCards; }
            set
            {
                _MemberCards = value;
                this.OnPropertyChanged(o => o.MemberCards);
            }
        }
                        ...
                        Task.Factory.StartNew(() =>
                        {
                            ...
                            if (result.Code == "200")
                            {
                                CurrentWindow.Dispatcher.Invoke(new Action(() =>
                                {
                                    ...
                                    MemberCards = result.Result.MemberCards;
