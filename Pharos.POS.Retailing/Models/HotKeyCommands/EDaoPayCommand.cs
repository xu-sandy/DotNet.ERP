...
{
   public  class EDaoPayCommand : IHotKeyCommand
    {
            ...
            get
            {
                return new Action<Window>((win) =>
                {
                    if (win is PosWindow)
                    {
                        ...
                        {
                            var payItem = Global.Payways.FirstOrDefault(o => o.Mode == PayMode.EDaoPay);
                    ...
                    else if (win is ChoosePayWindow)
                    {
                        ...
                        window.SetPayItem(PosModels.PayMode.EDaoPay);
                    }
