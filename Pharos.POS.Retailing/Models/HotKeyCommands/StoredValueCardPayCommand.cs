...
{
    public class StoredValueCardPayCommand : IHotKeyCommand
    {
                ...
                return new Action<Window>((win) =>
                {
                    if (win is PosWindow)
                    {
                        if (PosViewModel.Current.OrderList.Count > 0)
                        {
                            ...
                            var payItem = Global.Payways.FirstOrDefault(o => o.Mode == PayMode.StoredValueCard);
                    ...
                    //    var payItem = Global.Payways.FirstOrDefault(o => o.Mode == PayMode.StoredValueCard);
                    //    if (payItem == null) return;
                    //    MultiPay page = new MultiPay(window.Price, window.PayAction, payItem);
                    ...
                    else if (win is ChoosePayWindow)
                    {
                        ...
                        window.SetPayItem(PosModels.PayMode.StoredValueCard);
                    }
