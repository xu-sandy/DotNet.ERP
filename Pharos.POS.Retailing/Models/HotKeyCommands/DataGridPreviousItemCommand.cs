...
{
    public class DataGridPreviousItemCommand : IHotKeyCommand
    {
                ...
                return new Action<Window>((win) =>
                {
                    ...
                    if (pagaDataGrid != null)
                    {
                        if (pagaDataGrid.CurrentGrid != null)
                        {
                            ...
                            {
                                pagaDataGrid.CurrentGrid.SelectedIndex = arr.Count() - 1;
                            ...
                            else if (arr != null && arr.Count() > 0 && pagaDataGrid.CurrentGrid.SelectedIndex > 0)
                            {
