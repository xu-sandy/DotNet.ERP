...
namespace Pharos.SyncService
{
    public class PosServerDbSyncServiceClient : System.ServiceModel.ClientBase<IPosServerDbSyncService>, IPosServerDbSyncService
    {
        ...
        public void CreateProviderForSyncSession(int companyId, string storeId, string syncService)
        {
            try
            {
                base.Channel.CreateProviderForSyncSession(companyId, storeId, syncService);
            }
            catch (Exception ex)
            {
                throw ex;
