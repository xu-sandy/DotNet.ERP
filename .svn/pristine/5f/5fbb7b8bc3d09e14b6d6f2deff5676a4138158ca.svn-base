...
{
    public class CommodityDiscountLocalService : BaseLocalService<CommodityDiscount>, IDiscountService<CommodityDiscountDAO>
    {
        public IEnumerable<CommodityDiscountDAO> LoadDiscount()
        {
            ...
            var query = (from a in CurrentRepository.QueryEntity
                         ...
                         where b.EndDate >= date && b.PromotionType == 1 && b.State != 2
                         select new CommodityDiscountDAO()
                         {
    ...
    public class CommodityDiscountDAO : CommodityPromotionDAO
    {
