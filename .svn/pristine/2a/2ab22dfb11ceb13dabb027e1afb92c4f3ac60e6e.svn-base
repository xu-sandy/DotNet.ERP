...
namespace QCT.Pay.Admin.Controllers
{
    public class BrandController : BaseController
    {
        ...
        {
            ViewBag.types = ListToSelect(DictionaryService.GetChildList(5).Select(o => new SelectListItem() { Value = o.DicSN.ToString(), Text = o.Title }), emptyTitle: "全部");
            return View();
        }
        ...
        {
            ViewBag.types = ListToSelect(DictionaryService.GetChildList(5,false).Select(o => new SelectListItem() { Value = o.DicSN.ToString(), Text = o.Title }), emptyTitle: "请选择");
            var obj = new ProductBrand() { Source=0};
            if (id.HasValue)
            {
