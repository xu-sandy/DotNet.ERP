                ...
                return new GeneralCommand<object>((o1, o2) =>
                {
                    if (PosViewModel.Current.PrintStatus == PrintStatus.Open)
                    {
                        ...
                        if (result.Code == "200")
                        {
                            ...
                            ticketModel.Receivable = result.Result.Received.ToString("0.###");
                            ...
                            //2017-02-21 增加订单支付方式codes 和支付时会员卡的余额
                            //ticketModel.ApiCodes = result.Result.ApiCodes;
                            ticketModel.CardAndBalances = result.Result.CardAndBalances;
