...
namespace Pharos.OMS.Retailing.Controllers
{
    public class SysUserController : BaseController
    {
        ...
        public ActionResult Save(int? id, int? deptId, string deptName)
        {
            ...
            ViewBag.Roles = RoleService.GetRolesByDept(deptId.GetValueOrDefault(), id.HasValue).Select(o => new SelectListItem() { Text = o.Title, Value = o.RoleId.ToString() }).ToList();
        ...
        {
            var model = UserService.GetOneByUID(CurrentUser.UID);
            ViewBag.Role = RoleService.GetSysRolesList();
            return View(model);
        }
