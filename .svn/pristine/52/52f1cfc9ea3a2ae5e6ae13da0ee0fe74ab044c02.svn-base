...
namespace Pharos.CRM.Retailing.Controllers
{
    public class SysAdminController : BaseController
    {
        ...
        {
            var datas = _menuBLL.GetMenusTreeList(2, CurrentUser.RoleIds);
        ...
        {
            ViewBag.stores = ListToSelect(Pharos.Logic.BLL.WarehouseService.GetList(true).Select(o => new SelectListItem() { Value = o.StoreId, Text = o.Title, Selected = Sys.CurrentUser.StoreId == o.StoreId }),emptyTitle:"请选择");
