...
namespace Pharos.Api.Retailing.Controllers
{
    ...
    public class LoginController : ApiController
    {
        ...
        private object MobileLogin(LoginRequest requestParams)
        {
            ...
            var jo = JObject.Parse(user.ToJson());
            var fullName = jo.Property("FullName", true);
            var roleId =jo.Property("RoleIds", true);
            var type = jo.Property("Type", true);
            var userCode = jo.Property("UserCode", true);
            var uid = jo.Property("UID", true);
            var photoUrl = jo.Property("PhotoUrl", true);
