...
namespace Pharos.Logic.BLL
{
    public class ProductCategoryService : BaseService<ProductCategory>
    {
        ...
        public static List<ProductCategory> FindPageList(NameValueCollection nvl, out int recordCount, bool showAll = true)
        {
            ...
            //         };
            var qd = BaseService<ProductRecord>.CurrentRepository.QueryEntity.Where(o=>o.CompanyId==CommonService.CompanyId);
        ...
        /// <returns></returns>
        public static List<int> GetChildSNs(List<int> bigSNs, bool containSelf = true)
        {
        ...
        {
            var obj = Find(o =>o.CompanyId==CommonService.CompanyId && o.CategorySN == sn);
            if (obj != null)
