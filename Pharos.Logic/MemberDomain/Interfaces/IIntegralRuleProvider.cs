...
namespace Pharos.Logic.MemberDomain.Interfaces
{
    ...
    public interface IIntegralRuleProvider
    {
        ...
        IIntegralRule VerifyRule(IIntegralRule providerRule, IScene scene);
        /// <summary>
        /// 运算表达式
        /// </summary>
        ...
        KeyValuePair<IIntegralRule, decimal> RunExpression(IIntegralRule efficientRule, IScene scene);
        /// <summary>
        /// 获取场景数据
        /// </summary>
