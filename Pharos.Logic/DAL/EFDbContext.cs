...
;
            ...
            //解决 EF默认会自动保留2位小数的问题。
            modelBuilder.Entity<SaleOrders>().Property(t => t.TotalAmount).HasPrecision(18, 4);
            modelBuilder.Entity<SaleOrders>().Property(t => t.Receive).HasPrecision(18, 4);
            modelBuilder.Entity<SaleOrders>().Property(t => t.PreferentialPrice).HasPrecision(18, 4);

            modelBuilder.Entity<SaleDetail>().Property(t => t.PurchaseNumber).HasPrecision(18, 4);
            modelBuilder.Entity<SaleDetail>().Property(t => t.BuyPrice).HasPrecision(18, 4);
            modelBuilder.Entity<SaleDetail>().Property(t => t.SysPrice).HasPrecision(18, 4);

            modelBuilder.Entity<SaleDetail>().Property(t => t.ActualPrice).HasPrecision(18, 4);
            modelBuilder.Entity<SaleDetail>().Property(t => t.AveragePrice).HasPrecision(18, 4);
            modelBuilder.Entity<SaleDetail>().Property(t => t.Total).HasPrecision(18, 4);

            modelBuilder.Entity<WipeZero>().Property(t => t.Number).HasPrecision(18, 4);

            modelBuilder.Entity<Inventory>().Property(t => t.StockNumber).HasPrecision(18, 4);
            modelBuilder.Entity<InventoryRecord>().Property(t => t.Number).HasPrecision(18, 4);

            modelBuilder.Entity<InventoryBalance>().Property(t => t.Number).HasPrecision(18, 4);
            modelBuilder.Entity<InventoryBalance>().Property(t => t.SaleAveragePrice).HasPrecision(18, 4);
            modelBuilder.Entity<InventoryBalance>().Property(t => t.SaleAmount).HasPrecision(18, 4);
            modelBuilder.Entity<InventoryBalance>().Property(t => t.StockAmount).HasPrecision(18, 4);
            modelBuilder.Entity<ProductGroup>().Property(t => t.Number).HasPrecision(18, 4);
#if (Local!= true)

            modelBuilder.Entity<StockTakingLog>().Property(t => t.Number).HasPrecision(18, 4);
            modelBuilder.Entity<StockTaking>().Property(t => t.LockNumber).HasPrecision(18, 4);
            modelBuilder.Entity<StockTaking>().Property(t => t.ActualNumber).HasPrecision(18, 4);
            modelBuilder.Entity<InboundList>().Property(t => t.InboundNumber).HasPrecision(18, 4);
            modelBuilder.Entity<IndentOrderList>().Property(t => t.AcceptNum).HasPrecision(18, 4);
            modelBuilder.Entity<IndentOrderList>().Property(t => t.DeliveryNum).HasPrecision(18, 4);
            modelBuilder.Entity<IndentOrderList>().Property(t => t.IndentNum).HasPrecision(18, 4);
            modelBuilder.Entity<OrderDistribution>().Property(t => t.DeliveryNum).HasPrecision(18, 4);
            modelBuilder.Entity<OrderDistribution>().Property(t => t.ReceivedNum).HasPrecision(18, 4);
            modelBuilder.Entity<OrderDistributionGift>().Property(t => t.IndentNum).HasPrecision(18, 4);
            modelBuilder.Entity<OrderDistributionGift>().Property(t => t.ReceivedNum).HasPrecision(18, 4);
            modelBuilder.Entity<CommodityReturnsDetail>().Property(t => t.ReturnNum).HasPrecision(18, 4);
            modelBuilder.Entity<SalesReturnsDetailed>().Property(t => t.Number).HasPrecision(18, 4);
            modelBuilder.Entity<OutboundList>().Property(t => t.OutboundNumber).HasPrecision(18, 4);
            modelBuilder.Entity<BreakageList>().Property(t => t.BreakageNumber).HasPrecision(18, 4);
            modelBuilder.Entity<HouseMoveList>().Property(t => t.OrderQuantity).HasPrecision(18, 4);
            modelBuilder.Entity<HouseMoveList>().Property(t => t.ActualQuantity).HasPrecision(18, 4);
            modelBuilder.Entity<HouseMoveList>().Property(t => t.DeliveryQuantity).HasPrecision(18, 4);
            modelBuilder.Entity<MembershipCard>().Property(t => t.Balance).HasPrecision(18, 4);
            modelBuilder.Entity<MembershipCard>().Property(t => t.ReChargeTotal).HasPrecision(18, 4);
            modelBuilder.Entity<MembershipCard>().Property(t => t.GiveTotal).HasPrecision(18, 4);
            modelBuilder.Entity<MembershipCard>().Property(t => t.Deposit).HasPrecision(18, 4);
#endif
            modelBuilder.Entity<CommodityDiscount>().Property(t => t.MinPurchaseNum).HasPrecision(18, 4);
            modelBuilder.Entity<BundlingList>().Property(t => t.Number).HasPrecision(18, 4);
            modelBuilder.Entity<FreeGiftPurchase>().Property(t => t.MinPurchaseNum).HasPrecision(18, 4);
        ...
        public DbSet<InstalmentRecord> InstalmentRecords { get; set; }
        ...
        public DbSet<RechargeGifts> RechargeGifts { get; set; }
        public DbSet<RechargeGiftsStage> RechargeGiftsStage { get; set; }
        public DbSet<MakingMembershipCard> MakingMembershipCard { get; set; }
        public DbSet<MemberRecharge> MemberRecharge { get; set; }
        public DbSet<MakingCouponCard> MakingCouponCard { get; set; }
        public DbSet<ReturnRules> ReturnRules { get; set; }
        public DbSet<CouponCardDetail> CouponCardDetail { get; set; }
        public DbSet<ReturnStageRules> ReturnStageRules { get; set; }
        public DbSet<OMS_CompanyAuthorize> OMS_CompanyAuthorize { get; set; }
        public DbSet<MembershipCardSetting> MembershipCardSetting { get; set; }
        public DbSet<ScaleSettings> ScaleSettings { get; set; }
        public DbSet<ScaleHistory> ScaleHistory { get; set; }
        public DbSet<Vw_MembershipCardPayDetails> Vw_MembershipCardPayDetails { get; set; }
        public DbSet<ProductImage> ProductImages { get; set; }
        public DbSet<IntegralFlows> IntegralFlows { get; set; }

        public DbSet<AppPaymentRecords> AppPaymentRecords { get; set; }

        public DbSet<Pharos.Sys.Entity.SysCustomMenus> SysCustomMenus { get; set; }
